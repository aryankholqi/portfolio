...
export default function ExperienceCard() {
  return (
    <Card className="md:w-[70%] mx-auto shadow-md dark:bg-darkGray-100 rounded-md pb-4">
      ...
      <CardBody>
        <ul className="list-disc text-gray-600 dark:text-darkGray-600 font-interMedium flex flex-col gap-y-2 text-sm w-[90%] md:w-1/2 mx-auto md:pl-6 lg:pl-16 xl:pl-28 2xl:pl-40">

...
export default function HeaderBox() {
  return (
    <div className="px-[2rem] lg:px-[6rem] xl:px-[13rem] mt-20 flex flex-col-reverse sm:grid sm:grid-cols-5 md:grid-cols-6 gap-x-12">
      <div className="sm:col-span-3 md:col-span-4">
        ...
        <div className="flex items-center gap-x-2">
          ...
          <p className="text-gray-600 dark:text-darkGray-600">Iran, Babolsar</p>
        </div>
      ...
      <div className="sm:col-span-2 md:col-span-2 relative mb-24 w-[70%] mx-auto sm:w-full">
        <Image src={myProfile} alt="" className="relative z-10 w-full h-full" />
        <div className="absolute w-[113%] sm:w-full h-[95%] top-12 -right-6 bg-gray-200 dark:bg-darkGray-200"></div>
      </div>
    </div>
  );
}
